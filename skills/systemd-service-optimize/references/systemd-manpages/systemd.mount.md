...
- Source file: `systemd.mount.html`
- Generated (UTC): `2026-03-31 01:55:49Z`
- Original URL: `https://www.freedesktop.org/software/systemd/man/latest/systemd.mount.html#LazyUnmount=`
...
[systemd.unit(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.unit.html#). Note
...
The
[systemd-mount(1)](https://www.freedesktop.org/software/systemd/man/latest/systemd-mount.html#) command
...
See [systemd-fstab-generator(8)](https://www.freedesktop.org/software/systemd/man/latest/systemd-fstab-generator.html#)
for details about the conversion from `/etc/fstab` to mount units.

The NFS mount option `bg` for NFS background mounts
as documented in [nfs(5)](https://man7.org/linux/man-pages/man5/nfs.5.html)
...
:   Takes a boolean argument. If true or no argument, a `BindsTo=` dependency
    ...
    comes from unit fragments, i.e. generated from `/etc/fstab` by [systemd-fstab-generator(8)](https://www.freedesktop.org/software/systemd/man/latest/systemd-fstab-generator.html#) or loaded from
...
:   The file system will be initialized
    ...
    See
    [systemd-makefs@.service(8)](https://www.freedesktop.org/software/systemd/man/latest/systemd-makefs@.service.html#).
...
:   Measures file system identity information (mount point, type, label, UUID, partition
    ...
    [systemd-pcrfs@.service(8)](https://www.freedesktop.org/software/systemd/man/latest/systemd-pcrfs@.service.html#)
...
:   Validates mount constraint metadata of the mounted file system after mounting
    it. This ensures the
    [systemd-validatefs@.service(8)](https://www.freedesktop.org/software/systemd/man/latest/systemd-validatefs@.service.html#)
    service is pulled in by the mount unit.

    Note that this option can only be used in `/etc/fstab`, and will be ignored
    when part of the `Options=` setting in a unit file. It is also implied for all
...
:   An additional filesystem to be mounted in the initrd. See
    ...
    [systemd.special(7)](https://www.freedesktop.org/software/systemd/man/latest/systemd.special.html#). This
...
[systemd(1)](https://www.freedesktop.org/software/systemd/man/latest/systemd.html#), [systemctl(1)](https://www.freedesktop.org/software/systemd/man/latest/systemctl.html#), [systemd-system.conf(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd-system.conf.html#), [systemd.unit(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.unit.html#), [systemd.exec(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.exec.html#), [systemd.kill(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.kill.html#), [systemd.resource-control(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.resource-control.html#), [systemd.service(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.service.html#), [systemd.device(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.device.html#), [proc(5)](https://man7.org/linux/man-pages/man5/proc.5.html), [mount(8)](https://man7.org/linux/man-pages/man8/mount.8.html), [systemd-fstab-generator(8)](https://www.freedesktop.org/software/systemd/man/latest/systemd-fstab-generator.html#), [systemd.directives(7)](https://www.freedesktop.org/software/systemd/man/latest/systemd.directives.html#), [systemd-mount(1)](https://www.freedesktop.org/software/systemd/man/latest/systemd-mount.html#)
