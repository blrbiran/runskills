...
- Source file: `systemd.resource-control.html`
- Generated (UTC): `2026-03-31 01:55:49Z`
- Original URL: `https://www.freedesktop.org/software/systemd/man/latest/systemd.resource-control.html#IPEgressFilterPath=`
...
:   Control access to specific device nodes by the executed processes. Takes two space-separated
    ...
    `w`, `m` to control *r*eading,
    *w*riting, or creation of the specific device nodes by the unit
    (*m*knod), respectively. This functionality is implemented using eBPF
    filtering.
...
:   The name of the slice unit to place the unit
    ...
    [systemd.service(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.service.html#), section
...
:   Specifies how
    ...
    **systemd-oomd**. If the cgroup passes the limits set by
    [oomd.conf(5)](https://www.freedesktop.org/software/systemd/man/latest/oomd.conf.html#) or
...
:   Overrides the default memory pressure limit set by
    [oomd.conf(5)](https://www.freedesktop.org/software/systemd/man/latest/oomd.conf.html#) for
...
:   Allows deprioritizing or omitting this unit's cgroup as a candidate when
    ...
    **systemd-oomd**, which will ignore this cgroup as a candidate and will not perform
    ...
    [systemd-oomd.service(8)](https://www.freedesktop.org/software/systemd/man/latest/systemd-oomd.service.html#)
    and [oomd.conf(5)](https://www.freedesktop.org/software/systemd/man/latest/oomd.conf.html#).
...
:   Controls memory pressure monitoring for invoked processes. Takes a boolean or one of
    ...
    [sd-event(3)](https://www.freedesktop.org/software/systemd/man/latest/sd-event.html#) may use
    [sd\_event\_add\_memory\_pressure(3)](https://www.freedesktop.org/software/systemd/man/latest/sd_event_add_memory_pressure.html#)
...
systemd 252
:   Options for controlling the Legacy Control Group Hierarchy ([Control Groups version 1](https://docs.kernel.org/admin-guide/cgroup-v1/index.html))
...
[systemd(1)](https://www.freedesktop.org/software/systemd/man/latest/systemd.html#), [systemd-system.conf(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd-system.conf.html#), [systemd.unit(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.unit.html#), [systemd.service(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.service.html#), [systemd.slice(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.slice.html#), [systemd.scope(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.scope.html#), [systemd.socket(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.socket.html#), [systemd.mount(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.mount.html#), [systemd.swap(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.swap.html#), [systemd.exec(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.exec.html#), [systemd.directives(7)](https://www.freedesktop.org/software/systemd/man/latest/systemd.directives.html#), [systemd.special(7)](https://www.freedesktop.org/software/systemd/man/latest/systemd.special.html#), [systemd-oomd.service(8)](https://www.freedesktop.org/software/systemd/man/latest/systemd-oomd.service.html#), The documentation for control groups and specific controllers in the Linux kernel:
