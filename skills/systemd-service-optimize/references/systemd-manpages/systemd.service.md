...
- Source file: `systemd.service.html`
- Generated (UTC): `2026-03-31 01:55:49Z`
- Original URL: `https://www.freedesktop.org/software/systemd/man/latest/systemd.service.html#ExecStop=`
...
The [systemd-run(1)](https://www.freedesktop.org/software/systemd/man/latest/systemd-run.html#)
...
- Instanced service units (i.e. service units with an "`@`" in their name) are assigned by
  ...
  [systemd.slice(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.slice.html#)), named after the
...
:   Configures the mechanism via which the service notifies the manager that the service start-up
    ...
    - The `exec` type is similar to `simple`, but the
      ...
      in [systemd.exec(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.exec.html#)
      for details).
    ...
    - Behavior of `notify` is similar to `exec`; however,
      ...
      [sd\_notify(3)](https://www.freedesktop.org/software/systemd/man/latest/sd_notify.html#) or
...
:   This option configures the time to wait for the service to terminate when it was aborted due to a
    ...
    [systemd.kill(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.kill.html#)). The core file will
...
:   These options configure the action that is taken in case a daemon service does not signal
    ...
    [systemd.kill(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.kill.html#)). If the
...
:   Configures the watchdog timeout for a service.
    ...
    for details.
    [sd\_event\_set\_watchdog(3)](https://www.freedesktop.org/software/systemd/man/latest/sd_event_set_watchdog.html#)
...
:   Configure how many file descriptors may be stored in the service manager for the
    service using
    [sd\_pid\_notify\_with\_fds(3)](https://www.freedesktop.org/software/systemd/man/latest/sd_pid_notify_with_fds.html#)'s
    ...
    [sd\_listen\_fds(3)](https://www.freedesktop.org/software/systemd/man/latest/sd_listen_fds.html#) for
...
:   Takes an argument of the form "`path[:fd-name:options]`",
    ...
    See [sd\_listen\_fds(3)](https://www.freedesktop.org/software/systemd/man/latest/sd_listen_fds.html#)
...
[systemd.syntax(7)](https://www.freedesktop.org/software/systemd/man/latest/systemd.syntax.html#). The
...
[libsystemd(3)](https://www.freedesktop.org/software/systemd/man/latest/libsystemd.html#) are
...
Promise](https://systemd.io/PORTABILITY_AND_STABILITY/), so it can be reimplemented by services with no external dependencies. For a
self-contained example, see
[sd\_notify(3)](https://www.freedesktop.org/software/systemd/man/latest/sd_notify.html#).

## See Also

[systemd(1)](https://www.freedesktop.org/software/systemd/man/latest/systemd.html#), [systemctl(1)](https://www.freedesktop.org/software/systemd/man/latest/systemctl.html#), [systemd-system.conf(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd-system.conf.html#), [systemd.unit(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.unit.html#), [systemd.exec(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.exec.html#), [systemd.resource-control(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.resource-control.html#), [systemd.kill(5)](https://www.freedesktop.org/software/systemd/man/latest/systemd.kill.html#), [systemd.directives(7)](https://www.freedesktop.org/software/systemd/man/latest/systemd.directives.html#), [systemd-run(1)](https://www.freedesktop.org/software/systemd/man/latest/systemd-run.html#)
