...
- Source file: `systemd.exec.html`
- Generated (UTC): `2026-03-31 01:55:49Z`
- Original URL: `https://www.freedesktop.org/software/systemd/man/latest/systemd.exec.html#AmbientCapabilities=`
...
:   Similar to `Environment=`, but reads the environment variables from
    ...
    [unicode byte order mark](https://www.unicode.org/glossary/#byte_order_mark).
...
:   If memory pressure monitoring is enabled for this service unit, the path to watch
    and the data to write into it. See [Memory Pressure
    Handling](https://systemd.io/MEMORY_PRESSURE) for details about these variables and the service protocol data they
    convey.
